# Fontaudio - Font Icon Set for Audio Developers

> Version 1.0 – validation stage - any (polite) feedback is welcome:
> use issues on this repo, [@fefanto](https://twitter.com/fefanto) on twitter, or drop a me a [mail](mailto:fefanto@gmail.com)
...
This Icon set wants to be the one-stop-free-shop for Audio Software Related icons.
Its goal is:
